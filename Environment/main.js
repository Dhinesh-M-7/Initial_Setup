...
const createAim = () => {
  const projection = BABYLON.MeshBuilder.CreateBox("projection", {
    height: 0.1,
    width: 1,
    depth: 80,
  });
  ...
  const arrow = BABYLON.MeshBuilder.CreateCylinder("sphere", {
    height: 0.1,
    diameter: 7,
    tessellation: 3,
  }); //{height: 0.01, diameter: 0, diameterTop: 1, diameterBottom: 1, tessellation: 3}
